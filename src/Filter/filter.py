...
#built in face-detaction package
face = cv2.CascadeClassifier('C:\Python310\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml')
hat=cv2.imread(r'C:\Users\Bruker\Projects\OfficePortal\src\Filter\hat.png')
glass=cv2.imread(r'C:\Users\Bruker\Projects\OfficePortal\src\Filter\glasses.png')
dog= cv2.imread(r'C:\Users\Bruker\Projects\OfficePortal\src\Filter\dog.png')
...
choice = 0
print('enter your choice filter to launch that: 1="put hat & glasses" ,any number="put dog filters" ')
